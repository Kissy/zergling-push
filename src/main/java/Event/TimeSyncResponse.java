...
public final class TimeSyncResponse extends Table {
  ...
  public boolean mutateServerTime(long serverTime) { int o = __offset(6); if (o != 0) { bb.putInt(o + bb_pos, (int)serverTime); return true; } else { return false; } }
  public long serverStartTime() { int o = __offset(8); return o != 0 ? (long)bb.getInt(o + bb_pos) & 0xFFFFFFFFL : 0L; }
  public boolean mutateServerStartTime(long serverStartTime) { int o = __offset(8); if (o != 0) { bb.putInt(o + bb_pos, (int)serverStartTime); return true; } else { return false; } }
